...
// ✅ ChatBubble inside ChatScreen.js
...
// ✅ Main ChatScreen
export default function ChatScreen({ userName = "User", userAvatar = "👤" }) {
  const [messages, setMessages] = useState([
    { id: "1", text: "Hi there! 👋", sender: "them", timestamp: "10:00 AM" },
    { id: "2", text: "Hello! How are you?", sender: "me", timestamp: "10:02 AM" },
    { id: "3", text: "I'm good, thanks! And you?", sender: "them", timestamp: "10:03 AM" }
  ]);
...
const styles = StyleSheet.create({
  ...
  status: { flexDirection: "row", alignItems: "center", marginLeft: "auto" },
  statusIndicator: {
  ...
  bubbleContainer: { marginBottom: 16, flexDirection: "row" },
  ...
  myBubble: { backgroundColor: "#0078fe", borderBottomRightRadius: 4 },
  ...
  myTimestamp: { color: "#e0e0e0", textAlign: "right" },
  theirTimestamp: { color: "#666", textAlign: "left" },
  inputContainer: {
    flexDirection: "row",
    padding: 16,
    backgroundColor: "white",
  ...
  sendButton: {
    marginLeft: 12, backgroundColor: "#0078fe",
